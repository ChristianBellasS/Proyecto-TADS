        ...
        'Datatables' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.datatables.net/2.3.4/js/dataTables.min.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '//cdn.datatables.net/2.3.4/css/dataTables.dataTables.min.css',
                ],
            ],
        ],
        'Select2' => [
